...
const HEADLINE = "Create your category";
...
export const CategoryCreation = () => {
    ...
    return (
        <Container sx={{height: "95%"}}>
            <Typography sx={{marginTop: "10px"}}variant="subtitle1">{HEADLINE}</Typography>
            <Grid container>
            ...
            <Button fullWidth variant="outlined" sx={{marginTop: "auto"}}>Create</Button>
        </Container>
    )
};
